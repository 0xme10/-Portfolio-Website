...
export const COVID_MINING_DESCRIPTION1 =
  "Performed an exploratory data analysis on a COVID-19 dataset with the use of statistics and plots. After we utilized Sklearn’s Linear, random forest Regression classifier to predict new and total cases of a country. Moreover, we applied a comparative analysis on the models.";
